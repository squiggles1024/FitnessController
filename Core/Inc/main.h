...
#define XINPUT_GAMEPAD_DPAD_DOWN_Pin GPIO_PIN_0
#define XINPUT_GAMEPAD_DPAD_DOWN_GPIO_Port GPIOA
#define XINPUT_GAMEPAD_DPAD_UP_Pin GPIO_PIN_1
#define XINPUT_GAMEPAD_DPAD_UP_GPIO_Port GPIOA
#define XINPUT_GAMEPAD_A_Pin GPIO_PIN_2
...
#define XINPUT_GAMEPAD_Y_Pin GPIO_PIN_5
#define XINPUT_GAMEPAD_Y_GPIO_Port GPIOA
#define XINPUT_GAMEPAD_X_Pin GPIO_PIN_6
#define XINPUT_GAMEPAD_X_GPIO_Port GPIOA
#define XINPUT_GAMEPAD_B_Pin GPIO_PIN_7
...
#define XINPUT_GAMEPAD_DPAD_RIGHT_Pin GPIO_PIN_0
#define XINPUT_GAMEPAD_DPAD_RIGHT_GPIO_Port GPIOB
...
#define XINPUT_GAMEPAD_DPAD_LEFT_Pin GPIO_PIN_14
#define XINPUT_GAMEPAD_DPAD_LEFT_GPIO_Port GPIOD
